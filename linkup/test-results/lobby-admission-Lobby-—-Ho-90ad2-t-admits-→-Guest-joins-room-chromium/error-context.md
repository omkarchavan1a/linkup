...
- Name: lobby-admission.spec.js >> Lobby — Host ADMITS guest >> Guest enters lobby → Host sees notification → Host admits → Guest joins room
- Location: e2e\lobby-admission.spec.js:121:3
...
- generic [active] [ref=e1]:
  - generic [ref=e5]: Entering secure channel...
  - alert [ref=e6]
```
